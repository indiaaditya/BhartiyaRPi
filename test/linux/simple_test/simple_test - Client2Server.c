...
#define SOCKET_SERVER_CLOSE_SOCKET								11
...
void modifyControlWord(uint16 uirSlave, uint16 uirDesiredStat, uint8 uiOffset)
{
    ...
    case CTL_WD_RESET_VE:
        uiCtlWd.split.h = 0;
        uiCtlWd.split.l &= ~BIT4;
        break;
...
void SetActualTqAndPosn()
{
    ...
    while (uiAttemptCntr < 10)
    {
        uiActualPosn = 123456;
        uiActualTq = 123;
        sprintf(txStr, "STP,%d,%d", uiActualPosn, uiActualTq);
...
void socketServerAction() {
    ...
    case SOCKET_SERVER_ANALYZE_QUERY:
        ...
        //This code needs to be moved to other location!
