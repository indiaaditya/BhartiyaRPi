...
//    int16 i16val;
    ...
    if (ec_init(ifname))
    {
        ...
        if (ec_config_init(FALSE) > 0)
        {
            ...
            while(1){
                //if(gl_deltaPrintFlag == 1){
                    printf("\n Total loops executed: %d\t%d\t%ld",uiLoopCntr, delMeIteration, myTime.tv_nsec);
                    delMeIteration++;
    
                    /*for(int i = 0; i < 900; i++){
                        printf("\n i: %d, gd: %lld", i, gl_deltaArr[i]);
                    }
                    */
                    gl_deltaPrintFlag = 0;
                    gl_deltaCntr = 0;
                ...
                //}
                //osal_usleep(10 * 10000);
                //osal_usleep(200000 * 5);
                osal_usleep(1000000);
            }
        }
