//Aditya: Sourced from https://github.com/wschoenell/SOEM/blob/master/test/linux/red_test/red_test.c
...
//   if (ec_init_redundant(ifname, ifname2))
   if (ec_init(ifname))//*
   {
      ...
      if ( ec_config(FALSE, &IOmap) > 0 )//* Slightly different but is working in our code
      {
         printf("%d slaves found and configured.\n",ec_slavecount);//*
         /* wait for all slaves to reach SAFE_OP state */
         ec_statecheck(0, EC_STATE_SAFE_OP,  EC_TIMEOUTSTATE);  //* Was being done later in our code moved it up.

         /* configure DC options for every DC capable slave found in the list */
         ec_configdc();//* Was being done later in our code moved it up.

         /* read indevidual slave state and store in ec_slave[] */
         ec_readstate();                                        //*This command was not there in our code.
         for(cnt = 1; cnt <= ec_slavecount ; cnt++)
         {

            //*Printf was not there. Added to our code.
            ...
            //* Our code is different here! digout is not there.
         ...
         //*In our case this code was being called oloop and iloop value setting. 
